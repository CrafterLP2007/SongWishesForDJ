<div>
    ...
    <x-form class="md:flex justify-center block items-center lg:mt-12 mt-0 w-full" wire:submit="search">
        <label class="input input-bordered flex items-center md:w-1/2 w-full">
            <input wire:model="searchTerm" type="text" class="grow"
                   placeholder="{!! __('pages/home.search.input_placeholder') !!}"/>
    ...
    <div class="grid grid-cols-1 md:grid-cols-4 gap-4 mt-12 mb-4">
        @foreach($songs as $song)
            <div class="card bg-base-100 shadow-xl card-bordered border-neutral">
                <div class="card-body">
                    <h2 class="card-title">{{ $song['name'] }}</h2>
                    <div class="divider"></div>
                    <img src="{{ $song['album']['images'][0]['url'] ? : asset("img/No_Logo.jpg") }}" alt="Albumcover">
                    <div class="divider"></div>
